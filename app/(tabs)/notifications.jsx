    ...
    return (
        <View className="p-12 space-y-4 flex-auto">
            ...
            <View className="h-20 space-y-4 justify-end">
                <TouchableOpacity className="bg-cyan-900 p-4 rounded-full w-full" onPress={openRequestPermissionPage}>
                    <Text className="text-base text-slate-100 text-center font-outfitbold">Keep me posted</Text>
                </TouchableOpacity>
